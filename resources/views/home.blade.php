...
@section('extend-css')
    <link href="{{ asset('assets/css/home/carousel.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/home/cards_slider.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/css/home/company_profile.css') }}" rel="stylesheet">
@endsection
...
@section('main-content')
    ...
    {{-- @include('partials.home.company_profile') --}}

    @include('partials.home.company_profile')
    @include('partials.home.news_events')
    {{-- cards slider --}}
    @include('partials.home.cards_slider')
